...
//	@ParsedField @InitializedField public static  int    simulation_length;        
//	/* An optional description of this particular model run. */
//	@ParsedField @InitializedField public static  String simulation_description;    
//
//	@ParsedField @InitializedField public static  int    start_year;
//
//	/* The area, in hectares, of each forest patch. */
//	@ParsedField @InitializedField public static  double cell_area;              
//	@ParsedField @InitializedField public static  int    randomSeed1;
//	@ParsedField @InitializedField public static  int    randomSeed2;
//	@ParsedField @InitializedField public static  int    randomSeed3;
//	@ParsedField @InitializedField public static  int    randomSeed4;
//	@ParsedField @InitializedField public static  int    randomSeed5;
//	@ParsedField @InitializedField public static  int    randomSeed6;
//
//	/** Budget minimum values */
//	@ParsedField @InitializedField public static  double min_timber_target, min_timber_budget, min_pol_budget;
//
//	/** Cost/value minimum values. */
//	@ParsedField @InitializedField public static  double min_harv_cost, min_poli_cost, min_timb_val;
//
//	/* Ranger Parameters */
//	/** Ranger initial budgets.  If the incremental budget model is used, the values for budget and capital are ignored. */
//	@ParsedField @InitializedField public static  double
...
//	@ParsedField @InitializedField public static  double forest_regen_time;          
//
//	/** Model for initial distribution of stand ages. */
//	@ParsedField @InitializedField public static  String initial_stand_age_model;
//	/** Initial stand age parameters. */
//	@ParsedField @InitializedField public static  int    initial_stand_age, initial_stand_age_min, initial_stand_age_max;       /* Initial age to assign to all the cells. */
//
//	@ParsedField @InitializedField public static  double initial_stand_age_mean, initial_stand_age_sd;    
//
//	/* The radius of the area to be protected surrounding a harvested cell. */
//	@ParsedField @InitializedField public static  double harvest_neighbor_embargo_radius;  
//	/* The number of years patches adjacent to a harvested patch must wait before they are harvestable. */
//	@ParsedField @InitializedField public static  int    harvest_neighbor_embargo_length;  
//
...
//	@ParsedField @InitializedField public static  String budget_adjust_method;
//
...
//
//	@ParsedField @InitializedField public static double pol_budget_target_pct;
//	@ParsedField @InitializedField public static double timb_budget_target_pct;
//
//	/* Params for political cost model */
//	/** The intercepts for the linear cost/value functions. */
//	@ParsedField @InitializedField public static  double alpha_harv_cost, alpha_timber_value, alpha_poli_cost;           /* The real value of timber on patches are adjustments of this base value. */
//
//	/** Do not adjust cost/value for elevations below this amount. */ 
//	@ParsedField @InitializedField public static  double elevation_adjust;
//
...
//	@ParsedField @InitializedField public static  String primary_strategy, secondary_strategy;
//
//	
//	/** Test field for in itializing from values read from file. */
//	@InitializedField public static double testInitDouble;
//	
