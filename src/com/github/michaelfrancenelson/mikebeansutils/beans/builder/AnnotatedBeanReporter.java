...
//			int naInt, double naDouble, 
	 ...
	 */
	public static <T> List<String> staticStringValReport(Class<T> clazz, String dblFmt) throws IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException
	{
	 ...
	 * @throws IllegalArgumentException 
	 */
	public void appendStaticToReport(Class<T> clazz, Object... additionalColumns) throws IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException
	{
