package com.github.michaelfrancenelson.mikebeansutils.swing;
...
import com.github.michaelfrancenelson.mikebeansutils.beans.memberState.BeanStateSetterFactory;
...
import com.github.michaelfrancenelson.mikebeansutils.beans.memberState.BeanStateSetterFactory.BeanPrimitiveFieldSetter;
...
public class MemberSetterTextField<T> extends JTextField
{
	...
	private void initialize()
	{
		...
		getInputMap().put(KeyStroke.getKeyStroke(KeyEvent.VK_TAB, InputEvent.SHIFT_DOWN_MASK ), "myCode");
		setToCurrentValue();
