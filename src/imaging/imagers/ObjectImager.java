...
public class ObjectImager<T> implements BeanImager<T>
{
	...
	@Override public String getCurrentFieldName() { return currentWatcher.getFieldName(); }
	...
	@Override public int getDataWidth() { return objectData.getWidth(); }
	@Override public int getDataHeight() { return objectData.getHeight(); }
